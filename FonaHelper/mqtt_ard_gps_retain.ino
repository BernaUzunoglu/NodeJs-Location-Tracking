...
#define AIO_SERVER      "2.59.119.251"
...
#define QoS 1  //En az bir kere dene gönderdiğinden emin olmak için tanımlanan ifade
#define RETAIN 1//sabit bir değer verdik retaıne
